...
AutoReqProv:    no
Requires:       conntrack-tools iproute libcgroup libcgroup-tools bridge-utils openldap-clients lvm2 lvm2-libs ipset iptables rrdtool bc docker-latest python34 skarnet treadmill-pid1 treadmill-bind treadmill-tktfwd
